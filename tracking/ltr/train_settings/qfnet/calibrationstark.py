...
def run(settings):
    ...
    settings.search_area_factor = {'template':2., 'search':5.}
    settings.output_sz = {'template': 128, 'search': 320}
    ...
    actor = actors.Create_Calibration(net=net, objective=objective, loss_weight=loss_weight, name='starklightning')
    # Optimizer
