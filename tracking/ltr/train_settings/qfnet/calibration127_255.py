...
def run(settings):
    ...
    settings.search_area_factor = {'template':2., 'search':255*2/127}
    settings.output_sz = {'template': 127, 'search': 255}
    ...
    actor = actors.Create_Calibration(net=net, objective=objective, loss_weight=loss_weight, name='siamrpn_mobilenet')
    # Optimizer
